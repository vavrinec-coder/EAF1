...
async function handleLoadOpexFormulas(): Promise<void> {
  ...
  try {
    await Excel.run(async (context) => {
      ...
      const formula =
        '=IFERROR(IF(Y$11=1,0,IF($M58=0,0,CHOOSE($M58,Y$26*INDEX($I58:$K58,MIN(3,Y$19)),Y$27*INDEX($I58:$K58,MIN(3,Y$19)),Y$28*INDEX($I58:$K58,MIN(3,Y$19)),Y$29*INDEX($I58:$K58,MIN(3,Y$19)),Y$33*(1+INDEX($I58:$K58,MIN(3,Y$19)))*$L58,Y$32*(1+INDEX($I58:$K58,MIN(3,Y$19)))*$L58,Y$30*(1+INDEX($I58:$K58,MIN(3,Y$19)))*$L58,Y$31*(1+INDEX($I58:$K58,MIN(3,Y$19)))*$L58,IF(Y$13=1,AVERAGEIFS(X58:$Y58,X$2:$Y$2,\">=\"&$N58,X$2:$Y$2,\"<=\"&$O58)*(1+INDEX($I58:$K58,MIN(3,Y$19)))^(1/12),X58*(1+INDEX($I58:$K58,MIN(3,Y$19)))^(1/12)),INDEX(X58:$Y58,X$4-$H58+1)*(1+INDEX($I58:$K58,MIN(3,Y$19)))^($H58/12),IF(Y$13=1,$L58*(1+INDEX($I58:$K58,MIN(3,Y$19)))^(1/12),X58*(1+INDEX($I58:$K58,MIN(3,Y$19)))^(1/12)),SUMIFS(Y$178:Y$277,$G$178:$G$277,$B58),SUMIFS(Y$42:Y$51,$G$42:$G$51,$B58),0,0,0,0,))),0)';
